    ...
    return {
        ...
        link : function (scope, tElement, tAttrs, transclude) {
          ...
          try {
            ...
            tElement.html('<b>No Data Found</b> - ' + err);
            $compile(tElement.contents())(scope);
          }
        }
      };
...
app.directive('select2Tabpermission', function($http, rest, $timeout) {
    return {
        ...
        link: function(scope, element, attrs, ngModelCtrl) {
            ...
            var tabs = { "due_today": 'Due Today', "assigned": 'Assigned', "ongoing": 'Ongoing', "qa_ready": 'QA Ready', "qa_issue": 'QA Issue', "pm_ready": 'PM Ready', "delivery": 'Delivery', "completed": 'Completed', "overdue": 'Overdue', "due_tomorrow": 'Due Tomorrow', "my_project": 'My Project', "upcoming": 'Upcoming', "approved": 'Approved', "all": 'All' };
            var arr = [];
